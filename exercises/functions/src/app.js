...
function avgNum(numOne, numTwo, numThree, numFour, numFive, numSix){
    var avg =(numOne+numTwo+numThree+numFour+numFive+numSix)/6;
    return avg;
}
...
function area(length,breadth){
    var areaOne = length*breadth;
    return areaOne;
    }
function perimeter(length,breadth){
    var perimeterTwo = 2*(length+breadth);
    return perimeterTwo;
}
...
function ageToYear(birthYear){
    console.log("what is your birth year?"); 
